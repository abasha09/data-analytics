      ...
      <div className="max-w-[1240] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            ...
            <p className="py-2 border-b mx-8 mt-8">Sent up to 2 GB</p>
          </div>
          <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3">
            Start Trial
          </button>
        </div>
        <div className="w-full shadow-xl bg-gray-50 flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300">
          <img
